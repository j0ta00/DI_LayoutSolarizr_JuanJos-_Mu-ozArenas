...
namespace DI_DALSolarizr
{
    public class DALAppoiment
    {
        ...
        public static List<Appoiment> getListOfAppoiments()
        {
            ...
            appoiments.Add(new Appoiment(new DateTime(2001, 12, 13, 18, 15, 00), "Incidence", new Costumer("Microsoft", "C/Windows Forms Nº2 ", "45471552")));
            ...
            appoiments.Add(new Appoiment(new DateTime(2002, 10, 13, 9, 15, 00), "Incidence", new Costumer("Microsoft", "C/ASP NET Core Nº6 ", "65477212")));
